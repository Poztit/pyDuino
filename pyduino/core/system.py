...
def executeCmdWait(cmd):
    ...
    try:
        subsubcmd.remove('') # enleve '' car bloque commande si present...
                             # sinon provoque erreur d'ou try except
    except:
        pass
...
class Ethernet():
    ...
    def localIP(self):
        ...
        # récupère l'élément voulu des adresses puis accès élément 0 (un dico) puis accès addr du dico
